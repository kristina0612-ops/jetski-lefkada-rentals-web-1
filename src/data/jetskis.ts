...
// Reihenfolge: Ena (Flaggschiff) → Tessera → Dio → Tria. Ena + Tessera teilen
// sich dasselbe Studio-Foto (gleiches grey-black Repaint), Dio + Tria sind
// die zwei mit roten Akzenten. Ein früherer Tausch (Tessera ↔ Ena) war ein
// Workaround für einen Bento-Wrap-Bug; seit Fleet2.astro auf 2×2-Grid mit
// gleichgroßen Karten umgestellt wurde, ist die ursprüngliche Reihenfolge
// wiederhergestellt.
